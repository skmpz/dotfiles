...
sudo pacman -S engrampa evince virtualbox-host-modules-arch caja neovim chromium synergy qt4 qt vlc transmission-gtk --noconfirm --needed > /dev/null 2> .install.log
check $?
