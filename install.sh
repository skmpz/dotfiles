...
sudo pacman -S engrampa gvim evince virtualbox-host-modules-arch caja neovim chromium synergy qt4 qt5-base vlc transmission-gtk --noconfirm --needed > /dev/null 2>> .install.log
check $?
